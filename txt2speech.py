...
class STT:
    def __init__(self, model_name='small.en', max_silence_seconds=2, silence_threshold=4000, chunk=1024, sample_format=paInt16, channels=1, fs=16000, max_seconds=60):
        print('Loading model')
